...
export default function Card() {
    return (
        <>
            <div className={`col-md-5 px-md-3 py-md-2 ${style.yellowBorder} ${style.cardColor} ${style.card}`} >
                    ...
                    <div className={`col-12  mt-md-5`}>
                        <div className={`row `}>
                            ...
                            <div className={`col-1 ${style.redBorder}`}>
                                <div style={{height: '100%', backgroundColor: `${style.greyColor}`, width: '1px'}}></div>
                            </div>
